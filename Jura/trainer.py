...
def train_MSH(solver,
    ...
    for epoch in epoch_iter:
        ...
        if val_epoch_results["hv"] > val_hv:
            ...
            torch.save(hnet,'save_models/Jura_MH_Freely_'+ str(head) + "_" + str(lamda) + '_best.pt')
    ...
    torch.load('save_models/Jura_MH_Freely_'+ str(head) + "_" + str(lamda) + '_best.pt')
    ...
    np.save("fronts/Jura_MH_Freely_"+ str(head) + "_" + str(lamda) + "_front.npy", pf)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--gpus", type=str, default="3", help="gpu device")
    parser.add_argument(
        "--optim",
        type=str,
        default="adam",
    ...
    lamda = args.lamda
    sys.stdout = open("log/Jura_MH_Freely_"+ str(head) + "_" + str(lamda) + "_" + str(bs) + "_log.txt", 'w')
